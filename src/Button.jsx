...
function Button({text}) {
  ...
  before:w-full before:h-[110%] before:bg-primary-500 before:absolute before:rounded-full before:top-0 before:left-0 before:-translate-x-[110%] before:transition-all before:duration-1000 before:z-0
