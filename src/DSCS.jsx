...
<TextSection
        ...
        copy="Creating the system from scratch would have been inefficient. We decided to leverage open-source libraries to expedite the process. After thorough research, we chose Tailwind for styling and Radix UI for basic components. This combination struck a balance between efficiency and flexibility."
      />
      ...
      <TextSection
        ...
        copy="Our goal was a design system spanning all platforms (iOS, Android, Web, etc.). We opted for a multi-file Figma system, starting with a 'Tokens' file for basic elements (colors, typography, icons), followed by a 'Core Components' file for universal components, and finally, platform-specific files."
      />
      ...
      <ContentSection
        ...
        contentOne={{
          ...
          caption: true,
          captionText:
            "The architecture of the Figma design system.",
        }}
      />
...
<ContentSection
        ...
        contentOne={{
          ...
          caption: true,
          captionText:
            "Documentation for the Toggle Group Item component.",
        }}
      />
...
<TextSection
        ...
        copy="The project gained momentum, leading to the creation of numerous components and a robust system. Things were finally beginning to take shape, and we were able to start building out a few pages with our new system."
      />
...
<TextSection
        ...
        copy="Despite being deprioritized, the project was a success. The design system provided immediate benefits and prepared us for future developments. It also deepened my understanding of aligning design with development, a valuable asset for future projects."
      />
      </div>
